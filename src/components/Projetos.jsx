...
export default function Projetos() {
  const tecnologias = ["ReactJs", "Nextjs", "Styled Components", "Firebase"];
  ...
  return (
    <section className="mt-20 mb-10 lg:mt-40 ">
        ...
        <article className="md:p-5 p-2 bg-blue-800 bg-opacity-80 lg:flex rounded-3xl lg:gap-5">
                <div className="rounded-3xl max-sm:w-full bg-blue-600 flex justify-center md:p-5 p-2 lg:w-2/5">
                ...
                <div>
                    <h1 className="lg:text-4xl font-semibold">Blog Petshop</h1>
